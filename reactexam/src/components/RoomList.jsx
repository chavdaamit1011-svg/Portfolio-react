...
export default function RoomList() {
  ...
  const [availFilter, setAvailFilter] = useState("ALL"); // ALL | AVAILABLE | NOT_AVAILABLE
          ...
          <div key={r.id} className="col-md-4">
            <div className="card h-100 shadow-sm">
              <div className="card-body">
                ...
                <p className="mb-2">
                  <b>Features:</b> {Array.isArray(r.features) ? r.features.join(", ") : "-"}
                </p>

                <Link to={`/rooms/${r.id}`} className="btn btn-primary btn-sm">
                  View Details
                </Link>
              </div>
            </div>
